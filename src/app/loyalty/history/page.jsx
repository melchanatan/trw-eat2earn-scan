...
const HistoryPage = () => {
  ...
  return (
    <div className="h-screen flex flex-col justify-end box-container">
      ...
      <div className="h-[80vh] w-full bg-gradient-primary-lighter rounded-t-[14px] p-5 overflow-y-auto">
        {isLoading && (
...
const HistoryListItem = ({ name, amount }) => {
  return (
    <div className="w-full bg-white rounded-[12px] text-primary p-5 flex justify-between mb-4">
      <div>
